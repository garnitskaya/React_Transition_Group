...
const Modal = (props) => {
    ...
    return (
        //unmountOnExit -компонент остается смонтированным после достижения 'exited'состояния. Установите, unmountOnExitесли вы предпочитаете отключать компонент после завершения работы.
        <Transition
            in={props.show}
            timeout={duration}
            unmountOnExit
